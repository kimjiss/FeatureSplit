...
parser.add_argument('--datadir', default='/home/jisu/Desktop/Data/ILSVRC/')
...
def main():
    ...
    trainset = torchvision.datasets.CIFAR100('/home/jisu/Desktop/Data/', train=True, download=True, transform=transforms.ToTensor())
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batchsize, shuffle=True, num_workers=2)
    testset = torchvision.datasets.CIFAR100('/home/jisu/Desktop/Data/', train=False, download=True, transform=transforms.ToTensor())
